    ...
    >
        <div class="modal-inner modal-sm">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Delete Testimony</h5>
            </div>
            <div class="modal-body ">
                <p class="text-center"> Are you sure you want to delete this Testimony ?</p>
                @if(isset($testimonial))
                    <p class="text-center"> Name : <span>{{$testimonial->name}}</span></p>
                @endif
            </div>
