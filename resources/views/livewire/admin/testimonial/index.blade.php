        ...
        <table class="table table-bordered m-0">
            ...
            @forelse($testimonial as $k=>$testimonial)
                <tr wire:key="{{$k}}">
                    ...
                    <td>
                        <a href="#" wire:click.prevent="$emitTo('admin.testimonial.edit','load',{{$testimonial}})" class="btn btn-default text-primary"><i class="fa fa-pen"></i> Edit</a>
                        <a href="#" wire:click.prevent="$emitTo('admin.testimonial.delete','load',{{$testimonial}})" class="btn btn-default text-danger"><i class="fa fa-trash"></i> Delete</a>
                    </td>
                </tr>
